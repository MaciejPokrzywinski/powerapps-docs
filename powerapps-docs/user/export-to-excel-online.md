...
The amount of record that can be exported from a view in Model-Driven App to Excel Online is limited to 5k records. To export more records use for example [Export to an Excel static worksheet](/powerapps-docs/blob/main/powerapps-docs/user/export-excel-static-worksheet)
